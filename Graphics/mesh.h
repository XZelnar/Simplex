...
public://static
	...
	static Mesh* CreateFromVertices(D3DXVECTOR3* vertices, D3DXVECTOR3* normals, D3DXVECTOR4* colors, D3DXVECTOR2* texcoords, int length, D3D11_PRIMITIVE_TOPOLOGY topology_, bool _createVBO);
